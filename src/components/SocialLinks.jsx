...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mohamed-aziz-kammoun-6424ba195/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Med.Aziz.Kammoun",
    icon: Instagram,
    url: "https://www.instagram.com/med.aziz.kammoun/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@medazizkammoun",
    icon: Github,
    url: "https://github.com/medazizkammoun",
    color: "#ffffff",
