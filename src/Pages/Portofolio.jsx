...
// Import your images
import project1Img from "../assets/img/background.png";
import cert1Img from "../assets/img/certificate1.png";
...
const localProjects = [
  {
    id: "1",
    Img: project1Img,
    Title: "Nexus Des voix perdues",
    Description: "web project with a fantasy experience",
    Link: "https://github.com/kammounmedaziz/virtual-museum"
  },
];
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#f1636f] to-[#a855f7]">
          <span style={{
            color: '#6366f1',
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2">
          Explore my journey through projects, events, and technical expertise. 
